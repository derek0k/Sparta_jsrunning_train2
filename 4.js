...
console.log(arr.map((number) => number * 10));
// 결과 값: [100, 200, 300]을 출력해주세요

// 2;
//배열 API filter 활용
var arr = [10, 22, 33];
console.log(arr.filter((number) => number % 5 === 0));
// 5의 배수를 찾아 반환해주세요
// 결과값 [10]을 출력해주세요
...
console.log(arr.filter((value) => value.length >= 4));
...
console.log(arr.filter((value) => value.length % 2 === 1));
...
console.log(student.some((person) => person.name === null));
